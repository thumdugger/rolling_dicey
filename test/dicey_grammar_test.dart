...
final parser = grammar.buildFrom(grammar.rules()).end();
...
void main() {
  group('implicit roll tests', () {
    ...
    test('d20', () {
      verify('d20', [[[null, [null, 'd', '20']], []]]);
    });

    test('3d6', () {
      verify('3d6', [[[null, ['3', 'd', '6']], []]]);
    });

    test('3d6+2', () {
      verify('3d6+2', [[[null, ['3', 'd', '6']], []], [[null, '+2'], []]]);
    });
  });

  group('explicit roll tests', () {
    test('roll 20', () {
      verify('roll 20', [[['roll', '20'], []]]);
    });

    test('roll d20', () {
      verify('roll d20', [[['roll', [null, 'd', '20']], []]]);
    });

    test('roll 3d6', () {
      verify('roll 3d6', [[['roll', ['3', 'd', '6']], []]]);
    });

    test('roll 3d6+2', () {
      verify(
          'roll 3d6+2', [[['roll', ['3', 'd', '6']], []], [[null, '+2'], []]]);
    });
  });
